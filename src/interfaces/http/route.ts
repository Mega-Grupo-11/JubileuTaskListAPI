...
import { ReadController } from './../controllers/task/read-controller';
...
router.get('/tasks', authenticateToken, async (req, res) => {
    await ReadController.getAllTasks(req, res);
});
...
router.get('/task/:id', authenticateToken, async (req, res) => {
    await ReadController.getTaskById(req, res);
});

router.get('/tasks/search', authenticateToken, async (req, res) => {
    await ReadController.search(req, res);
});