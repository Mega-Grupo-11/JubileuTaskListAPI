...
export namespace Prisma {
  ...
  */
  ...
  export type TarefaOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "titulo" | "descricao" | "dataPrevista" | "prioridade" | "status" | "createdAt" | "usuarioId", ExtArgs["result"]["tarefa"]>
  ...
  interface TarefaFieldRefs {
    ...
    readonly dataPrevista: FieldRef<"Tarefa", 'DateTime'>
  ...
  export type TarefaWhereInput = {
    ...
    dataPrevista?: DateTimeFilter<"Tarefa"> | Date | string
  ...
  export type TarefaScalarWhereWithAggregatesInput = {
    ...
    dataPrevista?: DateTimeWithAggregatesFilter<"Tarefa"> | Date | string
